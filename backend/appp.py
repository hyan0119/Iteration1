...
def plant_match():
    ...
    sunlight = data.get('numWindows')
    cycle = data.get('maintenanceAvailability')
    watering = data.get('buildingDirection')
...
# 在这里通过用户的选择进行植物筛选
    ...
    plants_data_detail_df = detail_plant_info(balcony_size, plant_df)
